defmodule DiabetesV1.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :basal_changes, DiabetesV1.BasalChanges.BasalChange
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, DiabetesV1.Repo)
  ...
  """
  def valid_password?(%DiabetesV1.Accounts.User{hashed_password: hashed_password}, password)
