defmodule ElixirGistWeb.AllGistsLive do
  # implements live view behaviour
  use ElixirGistWeb, :live_view
  alias ElixirGist.Gists
  alias ElixirGistWeb.Utilities.DateFormat

  # mount takes params, session, and socket
  # don't need params or session (call it uri)
  ...
  def gist(assigns) do
    ...
    <div class="justify-center px-28 w-full mb-20">
      ...
      <div id="gist-wrapper" class="flex w-full">
        <textarea
          id="syntax-numbers"
          class="syntax-numbers border-t rounded-bl-md rounded-tl-md"
          readonly
        ></textarea>
        <div
          id="highlight"
          class="syntax_area w-full border-r border-b border-t rounded-br-md rounded-tr-md"
          phx-hook="Highlight"
          data-name={@gist.name}
        >
